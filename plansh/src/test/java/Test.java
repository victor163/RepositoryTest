...
public void plansh(WebDriver driver){
    element=driver.findElement(By.xpath("/html/body/div/div[4]/div[1]/div/div[1]/div/a[1]"));
    element.click();
}
public void filtr(WebDriver driver){
    ...
    element=driver.findElement(By.xpath("/html/body/div[1]/div[4]/div[2]/div[2]/div[2]/div/div[4]/div[2]/div/div[1]/div[1]/span"));
    element.click();
